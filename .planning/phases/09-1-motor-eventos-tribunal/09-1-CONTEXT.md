...
| **D-pre-6** | Storage índices: JSON hardcoded em `src/data/indicesHistoricos.json` — atualização manual mensal pelo operador | Simplicidade vs API IBGE/BCB volátil | operador 2026-05-02 |
