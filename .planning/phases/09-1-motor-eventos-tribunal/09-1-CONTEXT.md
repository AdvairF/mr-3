...
| **D-pre-6** | Storage índices: JSON em `src/data/indicesHistoricos.json` populado AUTOMATICAMENTE via API BCB SGS (script `scripts/fetch-indices.js`). Operador roda `npm run fetch-indices` mensalmente. Códigos SGS validados audit 2.A.1 (2026-05-03): **433** (INPC), **7478** (IPCA-15 — não 7849, descontinuada 2019), **29541+29542** (componentes Taxa Legal — fallback Tentativa 2), **29543** (Taxa Legal mensal direta — Tentativa 1 preferencial). Bandeira 1 AUTORIZADA pelo operador 2026-05-02. | Automação BCB elimina manual mensal + Bandeira 1 autorizada na sessão revisão PLAN. Códigos corrigidos pós-audit 2.A.1. | operador 2026-05-02 (códigos atualizados 2026-05-03) |
...
| **R6** | Fonte índice ambígua (IPCA-15 vs IPCA pleno; Bacen usa IPCA-15) | RESOLVIDO audit 2.A.1 (2026-05-03) | Códigos validados via curls: **433** (INPC), **7478** (IPCA-15 mensal — cross-check com fator 29542 confirma), **29543** (Taxa Legal direta CMN 5.171/24). NÃO usar 4449 (IPCA cheio) nem 7849 (descontinuada 2019). Header JSON documenta `taxa_legal_fonte` (29543_direta OU 29541_29542_calculo_local_CMN) |
...
- **2.A.2**: ✅ RESOLVIDO 2026-05-03 — códigos SGS validados via curls audit 2.A.1: **433** (INPC), **7478** (IPCA-15 mensal — não 7849), **29541+29542** (Fator Selic + Fator IPCA-15 mensais — fallback Tentativa 2), **29543** (Taxa Legal mensal direta CMN 5.171/24 — Tentativa 1 preferencial)
